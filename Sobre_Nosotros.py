...
st.write("Equipo WAYNE ENTERPRISES de la Universidad de Málaga, Ingenieros del Software del plan de estudios de la UMA-ETSII 2010")

st.image("assets/logoDatathon.png", caption="WAYNE ENTERPRISES", use_container_width=True)
